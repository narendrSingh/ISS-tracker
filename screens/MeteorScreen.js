...
import {Alert, Text,View,FlatList,SafeAreaView, Platform} from 'react-native';
...
export default class MeteorScreen extends Component{
    ...
    getMeteors=()=>{
        axios
        .get('https://api.nasa.gov/neo/rest/v1/feed?api_key=pXC79Aax2HQ3541lQIryaCIZyHjl1PLXMzaGg4Oo')
        .then(response=>{
            ...
            <View>
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    <View style={styles.gifContainer}>
                        ...
                        <Text style={[styles.cardTitle, { marginTop: 20, marginLeft: 50 }]}>closest to earth-{item.close_approach_data[0].close_approach_data_full}</Text>
