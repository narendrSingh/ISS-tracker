...
import {Text,View,ImageBackground,SafeAreaView,StatusBar,StyleSheet, Platform, Alert,Image} from 'react-native';
import MapView,{Marker} from "react-native-maps";
import axios from 'axios';

export default class IssLoctionScreen extends Component{
    constructor(props){
        super(props);
        this.state={
            location:{}
            ...
            <ImageBackground source={require("../assets/iss_bg.jpg")}style={styles.backgroundImage}>
                ...
                <View style={styles.mapContainer}>
                    ...
                    region={{
                        ...
                        longitude:this.state.location.lonitude,
                        latitudeDelta:100,
                        longitudeDelta:100,
                    }}>
                        <Marker
...
//pXC79Aax2HQ3541lQIryaCIZyHjl1PLXMzaGg4Oo